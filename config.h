 ...
 */
static char *font = "Hack Nerd Font Mono:pixelsize=35:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
	...
	{ Mod1Mask|ControlMask,   XK_s,           externalpipe,   {.v = openurlcmd } },
